...
const EnvironmentPage = (
  ...
  const emptyServices =
    ...
    ((currentEnvironment.mariadb?.length || 0) === 0 &&
      ...
      (currentEnvironment.sqlserver?.length || 0) === 0);
  ...
  const serviceTypes = [
    ...
    { value: "sqlserver", label: "SQLServer", icon: SqlServerIcon },
  ];
  ...
  const sqlserverActions = {
    start: api.sqlserver.start.useMutation(),
    stop: api.sqlserver.stop.useMutation(),
    move: api.sqlserver.move.useMutation(),
    delete: api.sqlserver.remove.useMutation(),
    deploy: api.sqlserver.deploy.useMutation(),
  };
      ...
      try {
        ...
        switch (service.type) {
          ...
          case "libsql":
            ...
            break;
          case "sqlserver":
            await sqlserverActions.start.mutateAsync({
      ...
      try {
        ...
        switch (service.type) {
          ...
          case "libsql":
            ...
            break;
          case "sqlserver":
            await sqlserverActions.stop.mutateAsync({ sqlserverId: serviceId });
            break;
        }
        success++;
      } catch {
      ...
      try {
        ...
        switch (service.type) {
          ...
          case "libsql":
            ...
            break;
          case "sqlserver":
            await sqlserverActions.move.mutateAsync({
              sqlserverId: serviceId,
              targetEnvironmentId: selectedTargetEnvironment,
            });
            break;
      ...
      try {
        ...
        switch (service.type) {
          ...
          case "libsql":
            ...
            break;
          case "sqlserver":
            await sqlserverActions.delete.mutateAsync({
              sqlserverId: serviceId,
            });
            break;
        }
      ...
      try {
        ...
        switch (service.type) {
          ...
          case "libsql":
            ...
            break;
          case "sqlserver":
            await sqlserverActions.deploy.mutateAsync({
              sqlserverId: serviceId,
            });
            break;
        }
